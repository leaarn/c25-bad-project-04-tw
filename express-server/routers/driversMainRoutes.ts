...
driversMainRoutes.get("/get-driver-info", driverIsLoggedInApi, driversMainController.getDriverInfo);
driversMainRoutes.get("/get-district", driverIsLoggedInApi, driversMainController.getDistricts);
driversMainRoutes.get("/get-orders", driverIsLoggedInApi, driversMainController.getAllOrders);
driversMainRoutes.get("/get-orders/:oid", driverIsLoggedInApi, driversMainController.getAcceptOrders);
driversMainRoutes.get("/driver-earns/:oid", driverIsLoggedInApi, driversMainController.getDriverEarns);
driversMainRoutes.get("/history/", driverIsLoggedInApi, driversMainController.getOrdersHistory);
