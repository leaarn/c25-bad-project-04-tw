...
export class DriversMainService {
  ...
  message = async (orderId: number) => {
    ...
    const data = getTextMessageInput(
      ...
      `Hi ${receiverName.receiver_name}! Here is your receiver token: ${tokenResult.token}. Click the link http://chickenvan.online/receivers.html to input your verification code. Have a great day!`
    );
